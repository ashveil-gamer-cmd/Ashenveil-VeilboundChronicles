...
const ECHO_CATALOG = [
  ...
  // ═══ EXPANSION BATCH — pushing catalog to 50 echoes ══════════════
  // Additional variety: more class signatures, more behavior options,
  // more build-defining mythics, more elemental flavor.

  // SHAPE
  {
    id: 'echo_spiral',
    name: 'Echo of the Spiral',
    type: 'shape', tier: 'uncommon',
    classLock: null, abilityLock: null,
    description: 'Projectile traces a tightening spiral before striking.',
    effects: { shapeOverride:'spiral', radiusMult:1.3, dmgMult:1.15 },
    dropSource: 'Crawlers in the deeper Ashen Wastes.',
  },
  {
    id: 'echo_crescent',
    name: 'Echo of the Waning Crescent',
    type: 'shape', tier: 'uncommon',
    classLock: null, abilityLock: null,
    description: 'Ability becomes a wide crescent sweep, +30% radius.',
    effects: { shapeOverride:'crescent', radiusMult:1.3 },
    dropSource: 'Shades at twilight.',
  },
  {
    id: 'echo_vertical_slam',
    name: 'Echo of the Sky-Fall',
    type: 'shape', tier: 'rare',
    classLock: null, abilityLock: null,
    description: 'Ability drops from above with a thunderous impact.',
    effects: { shapeOverride:'skyfall', dmgMult:1.4, radiusMult:1.1 },
    dropSource: 'Elites in the Ashen Cathedral.',
  },

  // ELEMENT
  {
    id: 'echo_venom',
    name: 'Echo of the Black Venom',
    type: 'element', tier: 'uncommon',
    classLock: null, abilityLock: null,
    description: 'Ability poisons targets, dealing damage over 5s.',
    effects: { elementTint:'#22c55e', poisonDuration:5000, poisonDps:0.15 },
    dropSource: 'Abominations in the Ashen Wastes.',
  },
  {
    id: 'echo_lightning',
    name: 'Echo of the Waking Storm',
    type: 'element', tier: 'rare',
    classLock: null, abilityLock: null,
    description: 'Ability electrifies. Arcs to 3 nearby enemies for 40% dmg.',
    effects: { elementTint:'#fde68a', addChain:3, dmgMult:0.9 },
    dropSource: 'Rare storm-touched wraiths.',
  },
  {
    id: 'echo_silver',
    name: 'Echo of the Silver Vein',
    type: 'element', tier: 'rare',
    classLock: null, abilityLock: null,
    description: '+25% damage. Ability ignores 20% of enemy damage reduction.',
    effects: { elementTint:'#e5e7eb', dmgMult:1.25, armorPen:20 },
    dropSource: 'The Crypt depths, rare boss drops.',
  },
  {
    id: 'echo_ruin',
    name: 'Echo of Slow Ruin',
    type: 'element', tier: 'mythic',
    classLock: null, abilityLock: null,
    description: 'Every enemy hit gets +1 stack of Ruin. Each stack = +5% dmg taken.',
    effects: { elementTint:'#7f1d1d', appliesRuin:1, ruinDuration:6000 },
    dropSource: 'Only from The First Hollow (T10 Veilgate).',
  },

  // BEHAVIOR
  {
    id: 'echo_rebounding',
    name: 'Echo of the Rebounding',
    type: 'behavior', tier: 'uncommon',
    classLock: null, abilityLock: null,
    description: 'Projectile bounces off the first wall or edge it strikes.',
    effects: { bounces:2, dmgMult:0.95 },
    dropSource: 'Rare chest drops in the Wraith Sanctum.',
  },
  {
    id: 'echo_acceleration',
    name: 'Echo of Gathering Speed',
    type: 'behavior', tier: 'rare',
    classLock: null, abilityLock: null,
    description: 'Projectile accelerates — hits at 2x speed deal +50% dmg.',
    effects: { accelerates:true, dmgMult:1.3, speedMult:1.5 },
    dropSource: 'Specters performing their ritual at night.',
  },
  {
    id: 'echo_delayed_ripple',
    name: 'Echo of the Still Pond',
    type: 'behavior', tier: 'rare',
    classLock: null, abilityLock: null,
    description: 'Ability echoes in ripples — re-triggers 3 times over 2s.',
    effects: { rippleCount:3, rippleInterval:700, rippleDmgMult:0.4 },
    dropSource: 'Dawn ritual in the Ashen Cathedral.',
  },
  {
    id: 'echo_piercing_focus',
    name: 'Echo of the Focused Wound',
    type: 'behavior', tier: 'rare',
    classLock: null, abilityLock: null,
    description: 'Pierces all enemies in a line. +60% dmg to the first hit.',
    effects: { addPierce:true, firstHitBonus:0.6, dmgMult:0.9 },
    dropSource: 'Skeletal Archers, uncommon.',
  },

  // RESONANCE
  {
    id: 'echo_kill_refund',
    name: 'Echo of the Endless Hunger',
    type: 'resonance', tier: 'rare',
    classLock: null, abilityLock: null,
    description: 'Killing a marked enemy refunds 30% of this ability\'s cooldown.',
    effects: { markedKillRefundPct:30 },
    dropSource: 'Crimson Harvest events.',
  },
  {
    id: 'echo_spirit_sacrifice',
    name: 'Echo of the Willing Sacrifice',
    type: 'resonance', tier: 'rare',
    classLock: 'hollowcaller', abilityLock: null,
    description: 'Consumes 1 spirit to deal +200% damage.',
    effects: { consumesSpirit:1, sacrificeDmgMult:3.0 },
    dropSource: 'Altars of the willing dead.',
  },
  {
    id: 'echo_rage_conversion',
    name: 'Echo of the Red Conversion',
    type: 'resonance', tier: 'rare',
    classLock: 'ironwake', abilityLock: null,
    description: '50% of Wrath resource converted to bonus damage this cast.',
    effects: { consumesWrath:50, wrathDmgMult:2.0 },
    dropSource: 'Bloodforged shrines at midnight.',
  },
  {
    id: 'echo_crit_compound',
    name: 'Echo of the Compounding Strike',
    type: 'resonance', tier: 'mythic',
    classLock: null, abilityLock: null,
    description: 'Crits on this ability grant +5% crit chance for 10s, stacking to 50%.',
    effects: { critCompoundPct:5, critCompoundDur:10000, critCompoundMax:10 },
    dropSource: 'Clear Veilgate T5 without using defensive abilities.',
  },
  {
    id: 'echo_zone_lockdown',
    name: 'Echo of the Frozen Moment',
    type: 'resonance', tier: 'mythic',
    classLock: null, abilityLock: null,
    description: 'Enemies hit are rooted (cannot move) for 2s.',
    effects: { rootDuration:2000 },
    dropSource: 'The Sundered Pillar — boss of Veilgate T7.',
  },

  // More common fillers so new players always have SOMETHING to slot
  {
    id: 'echo_tempered',
    name: 'Echo of the Tempered Will',
    type: 'behavior', tier: 'common',
    classLock: null, abilityLock: null,
    description: '+15% damage while you are above 75% HP.',
    effects: { highHpDmgMult:1.15, highHpThreshold:0.75 },
    dropSource: 'Common, from any enemy.',
  },
];
